"""Bridge between the channel layer and the underlying `lark_channel.Client`.
...
from lark_channel.api.im.v1.model.delete_message_request import DeleteMessageRequest
from lark_channel.api.im.v1.model.forward_message_request import ForwardMessageRequest
from lark_channel.api.im.v1.model.forward_message_request_body import ForwardMessageRequestBody
from lark_channel.api.im.v1.model.get_message_request import GetMessageRequest
from lark_channel.api.im.v1.model.list_message_reaction_request import ListMessageReactionRequest
from lark_channel.api.im.v1.model.patch_message_request import PatchMessageRequest
from lark_channel.api.im.v1.model.patch_message_request_body import PatchMessageRequestBody
...
from lark_channel.api.im.v1.model.update_message_request import UpdateMessageRequest
from lark_channel.api.im.v1.model.update_message_request_body import UpdateMessageRequestBody
...
class LarkClientDriver:
    """Adapt a `lark_channel.Client` instance into the driver methods we need."""
    ...
    async def list_reactions(
        ...
        *,
        ...
        req = builder.build()
        resp = await self._client.im.v1.message_reaction.alist(req)
        return _resp_to_dict(resp)
    ...
    async def upload_image(self, *, data: bytes, file_name: str = "") -> Dict[str, Any]:
        try:
            ...
            from lark_channel.api.im.v1.model.create_image_request_body import CreateImageRequestBody
    ...
    async def upload_file(
        ...
        *,
        ...
        try:
            ...
            from lark_channel.api.im.v1.model.create_file_request_body import CreateFileRequestBody
        except ImportError:  # pragma: no cover
    ...
    async def cardkit_create(self, *, body: Dict[str, Any]) -> Dict[str, Any]:
        ...
        from lark_channel.api.cardkit.v1.model.create_card_request_body import (
