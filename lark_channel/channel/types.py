...
class CachedResource:
    decision: Literal["cached", "rejected", "skipped"]
...
class SendResult:
    ...
    ``chunk_ids`` is ``None`` when there was only one chunk.
    """
...
class CardActionPayload:
    ...
    form_value: Any = field(default=None, compare=False, repr=False)
    input_value: Any = field(default=None, compare=False, repr=False)
    options: Any = field(default=None, compare=False, repr=False)
    checked: Any = field(default=None, compare=False, repr=False)
...
class ChatInfo:
    ...
    @property
    def chat_mode(self) -> Optional[str]:
        value = self.raw.get("chat_mode")
...
class QuoteResolution:
    ...
    decision: Literal["resolved", "no_parent", "in_batch", "topic_root", "fetch_failed"]
    context: Optional[QuotedContext] = None
